...
/// Overlay diplodocus : feuilles tombantes uniquement (comme la girafe).
class DiplodocusParticlesOverlay extends StatefulWidget {
  const DiplodocusParticlesOverlay({super.key});

  @override
  State<DiplodocusParticlesOverlay> createState() =>
      _DiplodocusParticlesOverlayState();
}

class _DiplodocusParticlesOverlayState
    extends State<DiplodocusParticlesOverlay>
...
// ─── Painter ───
class _DiplodocusPainter extends CustomPainter {
  final List<_FallingLeaf> fallingLeaves;
  final double progress;

  const _DiplodocusPainter({
  ...
  @override
  bool shouldRepaint(_DiplodocusPainter old) => old.progress != progress;
}
