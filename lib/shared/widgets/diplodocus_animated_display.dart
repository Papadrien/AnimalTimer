...
/// Affichage animé du diplodocus avec 3 layers (body, tail, head).
...
class DiplodocusAnimatedDisplay extends StatefulWidget {
  final double size;
  final bool animate;
  final bool playOnce;

  const DiplodocusAnimatedDisplay({
    super.key,
    this.size = 180,
    this.animate = true,
    this.playOnce = false,
  ...
  @override
  State<DiplodocusAnimatedDisplay> createState() =>
      _DiplodocusAnimatedDisplayState();
}

class _DiplodocusAnimatedDisplayState extends State<DiplodocusAnimatedDisplay>
  ...
  @override
  void didUpdateWidget(DiplodocusAnimatedDisplay old) {
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              ...
              _buildRotatedLayer(
                'assets/images/diplodocus/diplodocus_tail.png',
                size,
                tailAngle,
                _tailPivotX,
                _tailPivotY,
              ...
              _buildLayer('assets/images/diplodocus/diplodocus_body.png', size),
              // Layer 3 : Tête (devant le corps)
              _buildRotatedLayer(
                'assets/images/diplodocus/diplodocus_head.png',
                size,
                headAngle,
                _headPivotX,
                _headPivotY,
