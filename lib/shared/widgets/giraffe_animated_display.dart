...
/// Affichage animé de la girafe avec 3 layers (body, tail, head).
/// La tête tourne gauche-droite (pivot extrémité gauche de la bouche)
/// et la queue tourne haut-bas (pivot gauche de la queue).
///
/// [playOnce] : si true, joue exactement 1 cycle puis s'arrête.
///              si false, boucle indéfiniment.
class GiraffeAnimatedDisplay extends StatefulWidget {
  final double size;
  final bool animate;
  final bool playOnce;

  const GiraffeAnimatedDisplay({
    super.key,
    this.size = 180,
    this.animate = true,
    this.playOnce = false,
  ...
  @override
  State<GiraffeAnimatedDisplay> createState() => _GiraffeAnimatedDisplayState();
}

class _GiraffeAnimatedDisplayState extends State<GiraffeAnimatedDisplay>
  ...
  static const double _tailPivotY = 0.617;
  ...
  @override
  void didUpdateWidget(GiraffeAnimatedDisplay old) {
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              ...
              _buildRotatedLayer(
                'assets/images/giraffe/giraffe_tail.png',
                size,
                tailAngle,
                _tailPivotX,
                _tailPivotY,
              ...
              _buildLayer('assets/images/giraffe/giraffe_body.png', size),
              // Layer 3 : Tête (devant le corps)
              _buildRotatedLayer(
                'assets/images/giraffe/giraffe_head.png',
                size,
                headAngle,
                _headPivotX,
                _headPivotY,
