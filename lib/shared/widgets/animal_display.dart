...
import 'turtle_animated_display.dart';
import 'giraffe_animated_display.dart';
...
class _AnimalDisplayState extends State<AnimalDisplay>
  ...
  static const _animatedIds = {'cat', 'chicken', 'crocodile', 'dog', 'pony', 'shark', 'unicorn', 'turtle', 'giraffe', 'sheep', 'dragon'};
  ...
  Widget build(BuildContext context) {
    ...
    // Turtle multi-layer animation
    if (id == 'turtle' && !widget.useStaticImage) {
      return TurtleAnimatedDisplay(
        size: widget.size,
        animate: widget.animate,
        playOnce: widget.playOnce,
      );
    ...
    // Giraffe multi-layer animation
    if (id == 'giraffe' && !widget.useStaticImage) {
      return GiraffeAnimatedDisplay(
        size: widget.size,
        animate: widget.animate,
        playOnce: widget.playOnce,
      );
    ...
    // Sheep multi-layer animation
    if (id == 'sheep' && !widget.useStaticImage) {
      return SheepAnimatedDisplay(
        size: widget.size,
        animate: widget.animate,
        playOnce: widget.playOnce,
      );
    ...
    // Dragon multi-layer animation
    if (id == 'dragon' && !widget.useStaticImage) {
      return DragonAnimatedDisplay(
        size: widget.size,
        animate: widget.animate,
        playOnce: widget.playOnce,
      );
